...
<div id="page" class="stie style-body-light">
    <?php include_once  'include/mobile-nav.inc' ?>
    <div id="mainsite">
            ...
            <div class="main-container" id="maincontent">
                <div class="row">
                    <div <?php print $content_column_class; ?>>
                        ...
                        <?php endif; ?>
                        <div data-stellar-background-ratio="0.5" class="wrap_bg_header" id="block-title" style="background-image:url(<?php print file_create_url($background_404->uri) ?>)">
                            <div class="container">
                                <div class="wrap-title  is-metadesc ">
                                    <h1><?php print $title_404 ?></h1>
                                    <?php print check_markup($body_404['value'],$body_404['format']) ?>
                                    <?php
                                    if(isset($active_search_form) && $active_search_form == 1) {
                                        $search_form = drupal_get_form('search_form');
                                        $search_form['#attributes']['class'][] = 'searchform-wp';
                                        //$search_form['basic']['keys']['#theme'][] = 'mod_none_pre_render';
                                        $search_form['#theme'] = 'search_form_page';
