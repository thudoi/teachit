...
if($total > 0){
    if ($total <= $to) {
        $pager_page_text =  t('Showing !count of !total results',array('!count'=>$from.'-'.$total,'!total' => $view->total_rows));
    }
    else
    {
        $pager_page_text = t('Showing !count of !total results ',array('!count'=> $form.'-'.$to,'!total' => $view->total_rows));
    }
}
?>
...
<?php if ($exposed): ?>
    <div class="product-filter clearfix">
        <p class="jvshop-result-count"><?php print $pager_page_text; ?></p>
