...
?>
    <div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix "<?php print $attributes; ?>>
        <?php if(!$page): ?><span class="bpopup-close"></span><?php endif; ?>
            <div class="bpopup-portfolio-inner">
                <div class="row">
                    <div class="col-sm-6">
                        <?php print render($content['field_image_portfolio']) ?>
                    </div>
                    <div class="col-sm-6">
                        <h3>
                            <a href="#" rel="bookmark"><?php print $title ?></a>
                        </h3>
                        <?php print render($content['field_detail_portfolio']) ?>
                        <?php print render($content['field_tags_portolio']); ?>
                         <h5 class="color-main"><?php print ('Date'); ?></h5>
                        <p><?php print format_date($created,'custom','M d,Y') ?></p>
                        <?php print render($content['field_link_portfolio']); ?>
                    </div>
                </div>
            </div>
    </div>
