...
<div  class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
    <div class="inner-item">
        <div class="product-img">
                <?php print render($content['field_feature_product']); ?>
                <?php print render($content['field_image_product']) ?>
                <?php print render($content['field_products']); ?>
        </div>
        <div class="content-item-description">
            <h4 class="product-title"><a href="<?php print base_path().drupal_get_path_alias('node/'.$node->nid) ?>"><?php print $title ?></a></h4>
            <div class="product-price">
                <?php print render($content['product:commerce_price']) ?>
            </div>
            <div class="rate">
                <?php print render($content['field_rate_product']); ?>
            </div>
            <div class="description" >
                <?php print render($content['field_sumary_product']) ?>
            </div>
        </div>
    </div>
</div>