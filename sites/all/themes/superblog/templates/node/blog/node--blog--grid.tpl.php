 ...
 */
?>
<div id="node-<?php print $node->nid; ?>" class="blog-item  <?php print $classes; ?> clearfix"<?php print $attributes; ?>>
    ...
    <div class="blog-item-description is_thumbnail_large">
      ...
      <h3 class="entry-title"><a href="<?php print $node_url ?>"><?php print truncate_utf8($title, 40, TRUE, TRUE);  ?></a></h3>
