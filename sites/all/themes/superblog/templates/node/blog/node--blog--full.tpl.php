...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
    <div class="media_multi">
	  <?php if(isset($node->field_media_multi['und'][0]['fid'])) :?>
        <?php print render($content['field_media_multi']) ?>
	  <?php else: ?>
		<?php print render($content['field_screenshot']) ?>
	  <?php endif; ?>
    </div>
    <div class="blog-content-post">
        <div class="rating">
            <?php print render($content['field_rate_blog']) ?>
        </div>
      <?php if(isset($content['field_document'])){?>
          <div class="blog_document">
            <?php print render($content['field_document']) ?>
            <?php if(isset($node->field_document['und'][0]['description'])){?>
              <div class="field">
                  <div class="field-label">Description:&nbsp;</div>
                  <span class="description"><?php print $node->field_document['und'][0]['description']?></span>
              </div>
            <?php } ?>
          </div>
      <?php } ?>
        ...
        <?php } ?>
        <?php if(isset($share_post)): ?>
                <?php print $share_post ?>
        <?php endif; ?>
        <?php
