...
<div id="node-<?php print $node->nid; ?>" class="blog-item  row_item_single <?php print $classes; ?> clearfix"<?php print $attributes; ?>>
    <div class="thumbnail_large blog-thumbnail  thumbnail_effect_image3D">
        <?php if($filemime == 'image'):?>
            <a class="link-detail coloricon-picture3" href="blog-detail.html"><i class="icon-picture3"></i></a>
        ...
        <div class="entry-meta-thumb ItemLinksBlock ItemLinks  ">
            ...
            <span class="text-readmore text-center"> <a rel="bookmark" href="blog-detail.html" class="btn-round50 icon-arrow-right7"> </a> </span>
        </div>
        <?php else: print render($content['field_media_multi']); endif; ?>
    </div>
    <div class="blog-item-description is_thumbnail_large">
        <h3 class="entry-title"> <a rel="bookmark" href="<?php print $node_url ?>"><?php print $title ?></a> </h3>
